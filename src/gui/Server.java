...
public class Server {
	...
	//Der Server nimmt alle Client-Verbindungen an, holt sich den OUtputStream und er�ffnet einen Thread
	...
	//Sollte der Server nicht gestartet werden k�nnen, wird die andere Nachricht ausgegeben
	...
	//Der Iterator z�hlt die Nachrichten und solange noch eine Nachricht gesendet wird,
